...
- **当日供給板（Live Supply Board）** = 今この場で出している短命投稿。**他人の post のみ表示** (自分の post は `/venue/my-posts` で管理、PR feat/venue-supply-board-exclude-own-posts 適用済)。
...
| 当日供給板 | 募集閲覧 (他人の post のみ) | 写真・譲 / 求・投稿者 Trust・残時間 | Hold 申請 | 「募集なし」/ 期限切れは非表示 | P0 |
